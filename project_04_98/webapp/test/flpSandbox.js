		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "UX410 문제",
									"targetURL": "#sapbtpproject0498-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtpproject0498-display": {
								"semanticObject": "sapbtpproject0498",
								"action": "display",
								"description": "UX410 문제",
								"title": "UX410 문제",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.project0498",
									"url": sap.ui.require.toUrl("sap/btp/project0498")
								}
							}
						}
					}
